    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            @if(Session::get('success'))
                ...
                @endif
            <form method="POST" enctype="multipart/form-data" action="{{url('/newsSubmenuStore')}}">
                @csrf
                ...
                <div class="input-single-box">
                    ...
                    <input type="text" name="news_submenu_name" class="form-control" value="{{old('news_submenu_name')}}">
                </div>
                <div class="input-single-box">
                    <label>Status</label>
