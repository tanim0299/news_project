...
<div class="links" style="margin-top: 20px;">
    <a href="{{url('viewDistrict')}}" class="btn btn-outline-info">View District</a>
</div>
</div>
</div>
</div>
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            @if(Session::get('success'))
                ...
                @endif
            @if($district)
            <form method="POST" enctype="multipart/form-data" action="{{url('/districtUpdate')}}/{{$district->id}}">
                @csrf
                <div class="input-single-box">
                    ...
                    <select class="form-control" name="country_id" id="country_id">
                        ...
                        <option @if($district->country_id == $showcountry->id) selected @endif value="{{$showcountry->id}}">{{$showcountry->country_name}}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
