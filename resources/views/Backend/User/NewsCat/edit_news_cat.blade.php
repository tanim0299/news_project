...
<div class="d-inline">
<h5>Edit News Categorey</h5>
<!-- <span>This Is SBIT Dashboard</span> -->
<div class="links" style="margin-top: 20px;">
    <a href="{{url('viewNewsCat')}}" class="btn btn-outline-info">View News Categorey</a>
</div>
</div>
</div>
</div>
 ...
 <div class="form-body">
    <div class="card">
        ...
        <div class="card-block">
            ...
            @if($data)
            <form method="POST" enctype="multipart/form-data" action="{{url('/newsCatUpdate')}}/{{$data->id}}">
                @csrf
