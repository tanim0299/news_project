...
<div class="d-inline">
<h5>Edit News Main Menu</h5>
<!-- <span>This Is SBIT Dashboard</span> -->
<div class="links" style="margin-top: 20px;">
    <a href="{{url('viewNewsMenu')}}" class="btn btn-outline-info">View News Main Menu</a>
</div>
</div>
</div>
</div>
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            @if(Session::get('success'))
                ...
                @endif
                @if($data)
            <form method="POST" enctype="multipart/form-data" action="{{url('/newsMenuUpdate')}}/{{$data->id}}">
                @csrf
