...
<link rel="stylesheet" type="text/css" href="{{asset('public/components')}}/bower_components/bootstrap-multiselect/css/bootstrap-multiselect.css" />
<link rel="stylesheet" type="text/css" href="{{asset('public/components')}}/bower_components/multiselect/css/multi-select.css" />
...
@else
<img src="{{asset('public/components')}}/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
@endif
